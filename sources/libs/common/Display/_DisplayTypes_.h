...
typedef enum
{
    EMPTY_FUNCTION          =  0,
    SET_BRIGHTNESS          =  1, // 1
    SET_ORIENTATION         =  2, // 2 Установить ориентацию экрана. 0 - нормальная, 1 - обратная
    SET_PALETTE_COLOR       =  3, // 3 numColor:1 colorValue:2
    SET_COLOR               =  4, // 4 numColor:1
    SET_FONT                =  5, // 5 numFont:1
    DRAW_TEXT               =  6, // 6
    DRAW_PIXEL              =  7, // 7 x:2 y:1
    DRAW_LINE               =  8, // 8 Нарисовать линию
    FILL_REGION             =  9, // 9 x:2 y:1 width:2 height:1
    DRAW_MULTI_HPOINT_LINE  = 10, // 10 numLines:1 x:2 numPoints:1 dx:1 lines:numLines
    DRAW_MULTI_VPOINT_LINE  = 11, // 11 numLines:1 y:1 numPoints:1 dy:1 empty:1 lines:numLines*2
    DRAW_SIGNAL_LINES       = 12, // 12 x:2 points:281
    DRAW_SIGNAL_POINTS      = 13, // 13 x:2 points:281
    DRAW_VLINES_ARRAY       = 14, // 14 x0:2 numLines:1 lines:numLines * 2
    INVALIDATE              = 15, // 15
    RUN_BUFFER              = 16, // 16
    GET_PIXEL               = 17, // 17
    LOAD_IMAGE              = 18, // 18
    DRAW_HLINE              = 19, // 19 y:1 x0:2 x1:2
    DRAW_VLINE              = 20, // 20 x:2 y0:1 y1:1
    SET_REINIT              = 21, // 21
    LOAD_FONT               = 22, // typeFont:1 height:4 symbols:9 * 256 . Описание symbols смотри в Font.h
    NUM_COMMANDS            = 23
} Command;
